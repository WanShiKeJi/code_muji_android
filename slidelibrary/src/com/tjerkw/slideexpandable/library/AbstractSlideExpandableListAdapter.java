...
public abstract class AbstractSlideExpandableListAdapter extends
	 ...
	 *            下标
	 */
	public void checkExpandable(final View button, final View target,
			final int position) {
		Animation a = target.getAnimation();
	...
	private void animateView(final View target, final int type) {
		// View mAnimatedView = target;
		// int mEndHeight = mAnimatedView.getMeasuredHeight();
		// LinearLayout.LayoutParams mLayoutParams =
		// ((LinearLayout.LayoutParams) target
		// .getLayoutParams());
		// int mType = type;
		// if (mType == ExpandCollapseAnimation.EXPAND) {
		//
